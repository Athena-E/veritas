...
pub fn runtime_code() -> Vec<u8> {
    vec![
        ...
        0x55, 0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x20, 0x48, 0x89, 0xf8,
        0x45, 0x31, 0xc0, 0x48, 0x85, 0xc0, 0x79, 0x09, 0x48, 0xf7, 0xd8,
        0x41, 0xb8, 0x01, 0x00, 0x00, 0x00, 0x48, 0x8d, 0x7d, 0xff, 0xc6,
        0x07, 0x0a, 0x31, 0xc9, 0x49, 0xc7, 0xc1, 0x0a, 0x00, 0x00, 0x00,
        0x31, 0xd2, 0x49, 0xf7, 0xf1, 0x80, 0xc2, 0x30, 0x48, 0xff, 0xcf,
        0x88, 0x17, 0xff, 0xc1, 0x48, 0x85, 0xc0, 0x75, 0xec, 0x45, 0x85,
        0xc0, 0x74, 0x08, 0x48, 0xff, 0xcf, 0xc6, 0x07, 0x2d, 0xff, 0xc1,
        0x48, 0x89, 0xfe, 0x67, 0x8d, 0x51, 0x01, 0xb8, 0x01, 0x00, 0x00,
        0x00, 0xbf, 0x01, 0x00, 0x00, 0x00, 0x0f, 0x05, 0x48, 0x89, 0xec,
        0x5d, 0xc3,
        // __rt_print_char (offset 0x65, 25 bytes)
        // Input: rdi = ASCII byte value
        // Output: writes single byte to stdout
        0x57, 0x48, 0xc7, 0xc0, 0x01, 0x00, 0x00, 0x00, 0x48, 0x89, 0xe6,
        0xba, 0x01, 0x00, 0x00, 0x00, 0xbf, 0x01, 0x00, 0x00, 0x00, 0x0f,
        0x05, 0x5f, 0xc3,
        // __rt_read_int (offset 0x7e, 85 bytes)
        // Input: none
        // Output: rax = parsed decimal integer from stdin
        0x55, 0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x20, 0x31, 0xc0, 0x31,
        0xff, 0x48, 0x8d, 0x75, 0xec, 0xba, 0x14, 0x00, 0x00, 0x00, 0x0f,
        0x05, 0x48, 0x8d, 0x75, 0xec, 0x31, 0xc0, 0x31, 0xc9, 0x0f, 0xb6,
        0x16, 0x80, 0xfa, 0x2d, 0x75, 0x08, 0xb9, 0x01, 0x00, 0x00, 0x00,
        0x48, 0xff, 0xc6, 0x0f, 0xb6, 0x16, 0x80, 0xea, 0x30, 0x80, 0xfa,
        0x09, 0x77, 0x0f, 0x48, 0x6b, 0xc0, 0x0a, 0x0f, 0xb6, 0xd2, 0x48,
        0x01, 0xd0, 0x48, 0xff, 0xc6, 0xeb, 0xe6, 0x85, 0xc9, 0x74, 0x03,
        0x48, 0xf7, 0xd8, 0x48, 0x89, 0xec, 0x5d, 0xc3,
    ]
}
