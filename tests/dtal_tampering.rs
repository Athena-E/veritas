...
use veritas::verifier::{verify_dtal_text, VerifyTextError};
...
fn tampered_dtal_corpus_is_rejected() {
    let cases = [
        ...
        TamperCase {
            ...
            mutate: |dtal| {
                let dtal =
                    replace_once(dtal, ".precondition (v0 >= 0 && v0 < 4)", ".precondition (v0 >= 0 && v0 < 2)");
                replace_once(
                    &dtal,
                    ".assume (v0 >= 0 && v0 < 4)",
                    ".assume (v0 >= 0 && v0 < 2)",
        ...
        TamperCase {
            ...
            mutate: |dtal| {
                ...
                let dtal = replace_once(dtal.as_str(), "mov v1, 10    : int(10)", "mov v1, 1    : int(1)");
                replace_once(dtal.as_str(), "add v2, v0, v1    : int(52)", "add v2, v0, v1    : i64")
            },
        ...
        TamperCase {
            ...
            source: include_str!("../eval/feature_suite/programs/34_shared_scalar_deref.veri"),
            mutate: |dtal| {
                replace_once(dtal, "mov v4, 0    : int", "mov v4, -1    : int(-1)")
            },
            expected_error: "Bounds check failed",
        },
        TamperCase {
        ...
        TamperCase {
            ...
            source: include_str!("../eval/feature_suite/programs/37_mutable_scalar_borrow_call.veri"),
            mutate: |dtal| {
                replace_once(
                    dtal,
        ...
        TamperCase {
            ...
            source: include_str!("../eval/feature_suite/programs/33_mutable_borrow.veri"),
            mutate: |dtal| {
                replace_once(dtal, ".params {v0: &mut [int; 1]}", ".params {v0: &[int; 1]}")
            },
